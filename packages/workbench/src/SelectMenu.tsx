...
export const SelectMenu = defineSetupComponent<SelectMenuProps>('SelectMenu', [
  ...
  const selected = computed(() => props.options.find(option => option.value === props.value) ?? props.options[0])
  ...
  return () => {
    ...
    return <div class="select-menu" data-open={open.value} data-placement={props.placement ?? 'bottom'} ref={root}>
      <button
      ...
      {open.value ? <div aria-label={props.ariaLabel} class="select-menu-popover" role="listbox">
